 ...
 */
@Configuration
@ConditionalOnProperty(name = "onenet.protocol.enabled", havingValue = "true", matchIfMissing = false)
@ComponentScan(basePackages = "cn.onenet.protocol")
@EnableConfigurationProperties(OneNetProperties.class)
@Slf4j
public class OneNetAutoConfiguration {

  @Autowired(required = false)
  private OneNetModuleInfo moduleInfo;
  ...
  public void unregisterProtocol() {
    if (moduleInfo != null) {
      ...
      log.info("[OneNet自动配置] 协议模块已从运行时注册表注销");
    }
  }
}
