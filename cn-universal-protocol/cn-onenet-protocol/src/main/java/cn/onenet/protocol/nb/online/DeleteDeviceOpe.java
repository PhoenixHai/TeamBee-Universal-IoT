...
public class DeleteDeviceOpe extends BasicOpe {
  ...
  public JSONObject operation(Device device, String deviceId) {
    String a = device.toDeleteUrl(deviceId);
    return HttpSendCenter.delete(this.apiKey, device.toDeleteUrl(deviceId));
  }
}
