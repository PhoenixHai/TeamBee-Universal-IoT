 ...
 */
@Component
public class TableShardStrategyByIotId implements ITableShardStrategy {

  private static final Logger log = LoggerFactory.getLogger(TableShardStrategyByIotId.class);
  ...
  public void setMaxTableShard(Integer maxTableShard) {
    TableShardStrategyByIotId.maxTableShard = maxTableShard;
  }
  ...
  public void setVirtualNode(Integer virtualNode) {
    TableShardStrategyByIotId.virtualNode = virtualNode;
  }
